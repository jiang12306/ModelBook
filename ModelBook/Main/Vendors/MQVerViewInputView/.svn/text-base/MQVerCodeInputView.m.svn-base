...
//    CGFloat padding = (CGRectGetWidth(self.frame) -_maxLenght*CGRectGetHeight(self.frame))/(_maxLenght - 1);
    ...
    for (int i=0; i<self.maxLenght; i++) {
        ...
        subView.backgroundColor = [UIColor colorWithHex:0xc6c6c6];
...
//        subView.borderWidth = (0.5);
        ...
        subLabel.font = [UIFont fontWithName:pageFontName size:30.f];
        ...
        CGFloat linePadding = 20;
        UIBezierPath *path = [UIBezierPath bezierPathWithRect:CGRectMake((CGRectGetHeight(self.frame)- 2) / 2, linePadding / 2, 2, CGRectGetHeight(self.frame) - linePadding)];
