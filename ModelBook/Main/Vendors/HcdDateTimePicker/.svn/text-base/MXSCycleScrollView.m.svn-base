...
- (void)setAfterScrollShowView:(UIScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    [oneLabel setFont:[UIFont fontWithName:pageFontName size:15.f]];
    ...
    [twoLabel setFont:[UIFont fontWithName:pageFontName size:15.f]];
    ...
    [currentLabel setFont:[UIFont fontWithName:pageFontName size:15.f]];
    ...
    [threeLabel setFont:[UIFont fontWithName:pageFontName size:15.f]];
    ...
    [fourLabel setFont:[UIFont fontWithName:pageFontName size:15.f]];
