...
- (void)initDatas {
    _topViewColor = [UIColor colorWithHexString:@"0xffffff"];
...
- (void)setTimeBroadcastView
{
    ...
    okBtn = [[UIButton alloc]initWithFrame:CGRectMake(kScreen_Width - 90, 0, 90, kTopViewHeight)];
    [okBtn setTitleColor:[UIColor colorWithHexString:@"0x999999"] forState:UIControlStateNormal];
    okBtn.titleLabel.font = [UIFont fontWithName:pageFontName size:14.f];
    ...
    cancleBtn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, 90, kTopViewHeight)];
    cancleBtn.titleLabel.font = [UIFont fontWithName:pageFontName size:14.f];
    [cancleBtn setTitleColor:[UIColor colorWithHexString:@"0x999999"] forState:UIControlStateNormal];
    [cancleBtn setBackgroundColor:[UIColor clearColor]];
    [cancleBtn setTitle:NSLocalizedString(@"Cancle", nil) forState:UIControlStateNormal];
    ...
    titleLbl.font = [UIFont fontWithName:pageFontName size:13.f];
    ...
    [beforeSepLine setBackgroundColor:[UIColor clearColor]];
    ...
    [middleSepView setBackgroundColor:[UIColor colorWithHexString:@"0xd9d9d9"]];
    [timeBroadcastView addSubview:middleSepView];
    middleSepView.layer.borderWidth = 1.5;
    middleSepView.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    [bottomSepLine setBackgroundColor:[UIColor clearColor]];
...
- (void)setMonthScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.25, kTopViewHeight, kScreen_Width*0.25, kTimeBroadcastViewHeight)];
    }
...
- (void)setDayScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, kTopViewHeight, kScreen_Width*0.25, kTimeBroadcastViewHeight)];
    }
...
- (void)setHourScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.75, kTopViewHeight, kScreen_Width*0.25, kTimeBroadcastViewHeight)];
    }
...
- (void)setAfterScrollShowView:(MXSCycleScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    [oneLabel setFont:[UIFont fontWithName:pageFontName size:13.f]];
    [oneLabel setTextColor:[UIColor colorWithHexString:@"0x999999"]];
    UILabel *twoLabel = [[(UILabel*)[[scrollview subviews] objectAtIndex:0] subviews] objectAtIndex:pageNumber+1];
    [twoLabel setFont:[UIFont fontWithName:pageFontName size:13.f]];
    [twoLabel setTextColor:[UIColor colorWithHexString:@"0x999999"]];
    
    UILabel *currentLabel = [[(UILabel*)[[scrollview subviews] objectAtIndex:0] subviews] objectAtIndex:pageNumber+2];
    [currentLabel setFont:[UIFont fontWithName:pageFontName size:13.f]];
    [currentLabel setTextColor:[UIColor colorWithHexString:@"0x999999"]];
    
    UILabel *threeLabel = [[(UILabel*)[[scrollview subviews] objectAtIndex:0] subviews] objectAtIndex:pageNumber+3];
    [threeLabel setFont:[UIFont fontWithName:pageFontName size:13.f]];
    [threeLabel setTextColor:[UIColor colorWithHexString:@"0x999999"]];
    UILabel *fourLabel = [[(UILabel*)[[scrollview subviews] objectAtIndex:0] subviews] objectAtIndex:pageNumber+4];
    [fourLabel setFont:[UIFont fontWithName:pageFontName size:13.f]];
    [fourLabel setTextColor:[UIColor colorWithHexString:@"0x999999"]];
}
...
- (NSInteger)numberOfPages:(MXSCycleScrollView*)scrollView
{
    if (scrollView == yearScrollView) {
        ...
        if (self.datePickerMode == DatePickerDateMode || self.datePickerMode == DatePickerDateTimeMode || self.datePickerMode == DatePickerDateHourMinuteMode || self.datePickerMode == DatePickerDateHourMode) {
...
- (UIView *)pageAtIndex:(NSInteger)index andScrollView:(MXSCycleScrollView *)scrollView
{
    ...
    l.font = [UIFont fontWithName:pageFontName size:13.f];
        ...
        if (btns.tag == kOKBtnTag) {
            ...
            switch (self.datePickerMode) {
                ...
                case DatePickerDateHourMode:
                    dateTimeStr = [NSString stringWithFormat:@"%ld-%02ld-%02ld %02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour];
                    break;
                default:
                    dateTimeStr = [NSString stringWithFormat:@"%ld-%ld-%ld %02ld:%02ld:%02ld",(long)self.curYear,(long)self.curMonth,(long)self.curDay,(long)self.curHour,(long)self.curMin,(long)self.curSecond];
                    break;
